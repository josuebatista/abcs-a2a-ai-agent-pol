...
# First, create some test tasks to list
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"message/send","params":{"message":{"role":"user","parts":[{"type":"text","text":"Sentiment: Test 2"}]}},"id":"setup-2"}' > /dev/null
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"message/send","params":{"message":{"role":"user","parts":[{"type":"text","text":"Extract entities: Test 3"}]}},"id":"setup-3"}' > /dev/null
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"limit":2},"id":"test-2"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"page":2,"limit":1},"id":"test-3"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"status":"completed"},"id":"test-4"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"skill":"summarization"},"id":"test-5"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"status":"completed","skill":"sentiment-analysis"},"id":"test-6"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"page":-1},"id":"test-7"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"limit":200},"id":"test-8"}'
echo
echo
...
curl -s -X POST "$BASE_URL/rpc" \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"jsonrpc":"2.0","method":"tasks/list","params":{"status":"nonexistent"},"id":"test-9"}'
echo
echo
